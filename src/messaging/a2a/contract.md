...
This directory defines the canonical A2A task contract used by public transports and local runtime adapters.
...
`internal_contract.ts` is the single source of truth for canonical task invariants:

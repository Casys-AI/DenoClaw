...
export class WebFetchTool extends BaseTool {
  ...
  async execute(args: Record<string, unknown>): Promise<ToolResult> {
    ...
    try {
      ...
      return this.fail("INVALID_URL", { url }, "Provide a valid URL (e.g. https://example.com)");
    }
    ...
    try {
      ...
      if (msg.includes("AbortError") || msg.includes("timed out")) {
        return this.fail("FETCH_TIMEOUT", { url, method }, "URL took >30s to respond, try again or use a different URL");
      }
      return this.fail("FETCH_FAILED", { url, method, message: msg }, "Check the URL and network access");
    }
  }
}
